...
class CreateEditStokBarangAktifScreen extends StatefulWidget {
  @override
  _CreateEditStokBarangAktifScreenState createState() =>
      _CreateEditStokBarangAktifScreenState();
}

class _CreateEditStokBarangAktifScreenState
    extends State<CreateEditStokBarangAktifScreen> {
  //init
