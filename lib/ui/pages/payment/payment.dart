      ...
      body: Column(
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              children: [
                getPaymentTile('Pay on Visit',
                    'assets/images/payment_icon/cash_on_delivery.png'),
                getPaymentTile(
                    'Amazon Pay', 'assets/images/payment_icon/amazon_pay.png'),
                getPaymentTile('Card', 'assets/images/payment_icon/card.png'),
                getPaymentTile(
                    'PayPal', 'assets/images/payment_icon/paypal.png'),
                getPaymentTile(
                    'Skrill', 'assets/images/payment_icon/skrill.png'),
